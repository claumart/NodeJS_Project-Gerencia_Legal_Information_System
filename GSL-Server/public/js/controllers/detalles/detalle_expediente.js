...
app.controller("detailCtrl", function($scope, $http, $window, utilities, detailUtilities) {
    ...
    $http({
        method : "POST",
        url : "/detalle/expediente/obtenerfichaCompleta",
    ...
    $http({
        method : "POST",
        url : "/detalle/expediente/obtenerHistorialPrevision",
        headers: {'Content-Type': 'application/json'},
        data : {idFicha : $scope.urlParams.idFicha}
    }).then(function mySuccess(response) {
        var lista = JSON.parse(response.data);
    ...
    $http({
        method : "POST",
        url : "/detalle/expediente/obtenerPdf",
        headers: {'Content-Type': 'application/json'},
        data : {idFicha : $scope.urlParams.idFicha}
    }).then(function mySuccess(response) {
    ...
    $http({
        method : "POST",
        url : "/detalle/expediente/obtenerWord",
        headers: {'Content-Type': 'application/json'},
        data : {idFicha : $scope.urlParams.idFicha}
    }).then(function mySuccess(response) {
