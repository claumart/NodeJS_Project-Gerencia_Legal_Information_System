...
app.controller("seguimientoCtrl", function($scope, $http, $window, utilities) {
	...
	$scope.mostrarExpedientesRecibidos = ()=> {
		...
		$http({
        	method : "POST",
        	url : "http://localhost:3000/seguimiento/expedientes/mostrar/recibidos"
	...
	$scope.mostrarExpedientesAsignados1 = ()=> {
		...
		$http({
        	method : "POST",
        	url : "http://localhost:3000/seguimiento/expedientes/mostrar/asignados"
    	}).then(function mySuccess(response) {
    		var lista = JSON.parse(response.data);
        	$scope.expedientesList = utilities.formatearFecha(lista);
    	}, function myError(response) {
	...
	$scope.mostrarExpedientesDescargados = ()=> {
		...
		$http({
        	method : "POST",
        	url : "http://localhost:3000/seguimiento/expedientes/mostrar/descargados"
    	}).then(function mySuccess(response) {
    		var lista = JSON.parse(response.data);
        	$scope.expedientesList = utilities.formatearFecha(lista);
    	}, function myError(response) {
	...
	$scope.mostrarExpedientesRemitidos = ()=> {
		$http({
        	method : "POST",
        	url : "http://localhost:3000/seguimiento/expedientes/mostrar/remitidos"
    	}).then(function mySuccess(response) {
    		var lista = JSON.parse(response.data);
        	$scope.expedientesList = utilities.formatearFecha(lista);
    	}, function myError(response) {
	...
	$scope.mostrarExpedientesConPrevio = ()=> {
		...
		$http({
        	method : "POST",
        	url : "http://localhost:3000/seguimiento/expedientes/mostrar/conprevio"
    	}).then(function mySuccess(response) {
    		var lista = JSON.parse(response.data);
        	$scope.expedientesList = utilities.formatearFecha(lista);
    	}, function myError(response) {
	...
	$scope.mostrarExpediente = ()=> {
		...
		$http({
        	method : "POST",
        	url : "http://localhost:3000/seguimiento/expedientes/mostrar/expedienteParticular",
